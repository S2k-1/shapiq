...
:class:`~shapiq.vision.CNNArchitecture`; ``PatchStrategy`` belongs to
:class:`~shapiq.vision.TransformerArchitecture`.
"""
...
# --------------------------
# Pass the strategy to :class:`~shapiq.vision.CNNArchitecture`. The same
...
for name, strategy in strategies.items():
    architecture = CNNArchitecture(model=model, player_strategy=strategy)
...
from shapiq.vision import PatchStrategy, TransformerArchitecture
